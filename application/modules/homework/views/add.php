		...
		<div class="col-md-4">
			...
			<div class="form-group">
				<!-- <div class="form-group"> -->
                    ...
                    <input type="text" class="form-control datemask" required   name="start_date" id="date" value="<?= $this->input->post('start_date') ?>" >
                </div>
            ...
            <div class="col-md-4">
            	...
            	<div class="form-group">
            		...
            		<input type="text" class="form-control datemask" required value="<?= $this->input->post('description') ?>"   name="submission_date" id="submission_date">
            	</div>
            	<span class="text-danger"></span>
            </div>
            <div class="col-md-4">
