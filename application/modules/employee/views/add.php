...
<?php echo form_open_multipart('employee/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		<label for="paddress" class="col-md-10 control-label"><span class="text-danger">*</span>Permanent Address</label>
		<div class="col-md-10">
	...
	<div class="form-group">
		<label for="taddress" class="col-md-10 control-label"><span class="text-danger">*</span>Corresponding Address</label>
		<div class="col-md-10">
