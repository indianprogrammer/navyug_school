...
<body>
    <h1 class="title-agile text-center" style="margin-top: -10px;">ADMIN LOGIN</h1>
    ...
    ?>
            ...
            <?= form_open('institute/LoginController/admin_login_process') ?>
                <div class="field-group">
                    <div class="wthree-field">
                        <input name="email" id="text1" type="text" value="" placeholder="Email" required>
                    </div>
                    <span class="fa fa-user" aria-hidden="true"></span>
                    <div class="text-danger" style="color:red"><?php echo form_error('email'); ?></div>
                </div>
                <div class="field-group">
                    <div class="wthree-field">
