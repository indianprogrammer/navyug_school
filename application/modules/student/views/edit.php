          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="student_name" value="<?= ($this->input->post('student_name') ? $this->input->post('student_name') : $student['name']); ?>" class="form-control" id="student_name" required autofocus />
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="email" name="email" value="<?= ($this->input->post('email') ? $this->input->post('email') : $student['email']); ?>" class="form-control" id="email"  />
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="mobile" id="mobile" maxlength="13"  value="<?= ($this->input->post('mobile') ? $this->input->post('mobile') : $student['mobile']); ?>" class="form-control" id="mobile" maxlength="13" />
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div data-date-format="yyyy-M-d" class="input-group date">
                  <input class="form-control pickadate" name="dob" id="dob" type="text" value="<?= ($this->input->post('dob') ? $this->input->post('dob') : $student['dob']); ?>" maxlength="45" />
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <div class="col-md-12">
      <input type="text" name="aadhar" id="aadhar" maxlength="13"  value="<?= ($this->input->post('aadhar') ? $this->input->post('aadhar') : $student['aadhar']); ?>" class="form-control" id="aadhar" maxlength="13" />
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="col-md-12">
          <textarea name="paddress" class="form-control" id="paddress" value="<?= $this->input->post('paddress'); ?>" required><?= ($this->input->post('paddress') ? $this->input->post('paddress') : $student['permanent_address']); ?></textarea>
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-12">
          <input type="text" name="p_city"  value="<?= ($this->input->post('p_city') ? $this->input->post('p_city') : $student['p_city']); ?>" class="form-control" id="p_city" required />
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-12">
          <input type="text" name="p_pincode"    value="<?= ($this->input->post('p_pincode') ? $this->input->post('p_pincode') : $student['p_pincode']); ?>" class="form-control" id="p_pincode" maxlength="6" required />
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="col-md-12">
          <textarea name="taddress" class="form-control" id="taddress" value="<?= $this->input->post('taddress'); ?>" required><?= ($this->input->post('taddress') ? $this->input->post('taddress') : $student['temporary_address']); ?></textarea>
          <span class="text-danger"><?= form_error('temporary_address');?></span>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label for="mobile" class="col-md-4 control-label"><span class="text-danger">*</span>City</label>
        <div class="col-md-12">
          <input type="text" name="t_city"   value="<?= ($this->input->post('t_city') ? $this->input->post('t_city') : $student['t_city']); ?>" class="form-control" id="t_city" required />
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label for="mobile" class="col-md-4 control-label"><span class="text-danger">*</span>Pincode</label>
        <div class="col-md-12">
          <input type="text" name="t_pincode"  value="<?= ($this->input->post('t_pincode') ? $this->input->post('t_pincode') : $student['t_pincode']); ?>" class="form-control" id="t_pincode" maxlength="6" required />
