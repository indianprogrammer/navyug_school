...
class Account_model extends CI_Model
{
   ...
   {
       $this->db->select('student.*,invoices.invoice_id as inv,invoices.school_id,master_invoice.name as particular,master_invoice.price,school.address,invoices.date');
       $this->db->from('invoices');
       $this->db->join('account_transaction', 'account_transaction.reference_id=invoices.id', 'Left');
