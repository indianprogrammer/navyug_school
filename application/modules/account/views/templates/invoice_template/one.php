...
$obj_pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "vivek", PDF_HEADER_STRING);
...
<pre>$obj_pdf->SetCellPadding(0);</pre>
...
$obj_pdf->setHtmlVSpace($tagvs);</pre>
...
<pre>$obj_pdf->setCellHeightRatio(1.25);</pre>
...
<pre>$obj_pdf->setImageScale(0.47);</pre>
