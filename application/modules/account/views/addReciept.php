...
<div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-5 col-sm-12">
                        <label for="paid" class="control-label"><span class="text-danger">*</span>paid</label>
                        <div class="form-group">
                            <input type="text" name="paid"  value="<?= $this->input->post('paid') ?>"
                            class="form-control" id="paid" />
                            <span class="text-danger"><?= form_error('paid') ?></span>
                        </div>
                    </div>
