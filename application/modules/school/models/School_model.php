...
class School_model extends CI_Model
{
    ...
    {   
           $this->db->select('master_country.country_name,school.id, master_state.state_name,school_name,master_cities.city_name,address,latlong,contact_pri,contact_sec,email,logo,banner,master_country.id,master_cities.id,master_state.id,school.country_id,school.state_id,school.city_id');
