<?php echo form_open_multipart('subject/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-4 col-sm-8">
			<input type="text" name="subject_name" value="<?php echo $this->input->post('subject_name'); ?>" class="form-control" id="student_name" data-toggle="tooltip" title="tips- maths,physics...etc"  autofocus/>
